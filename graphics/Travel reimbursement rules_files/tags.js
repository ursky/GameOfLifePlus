    ...
    a.Tags = Class.create({
        ...
        ajaxTagDelete: function(d) {
            d.observe("click", function(e) {
                ...
                if (!d.disabled) {
                    new Ajax.Request(d.readAttribute("href").replace(/&xredirect=.+$/, "&ajax=1"), {
                        onCreate: function() {
                            d.disabled = true;
        ...
        createTagAddForm: function(d) {
            d.observe("click", function(e) {
                ...
                if (!d._x_form) {
                    if (!d.disabled) {
                        new Ajax.Request(d.readAttribute("href").replace(/#.+$/, "&ajax=1&xpage=documentTags"), {
                            onCreate: function() {
                                d.disabled = true;
        ...
        ajaxifyForm: function(e) {
            ...
            e.observe("submit", function(f) {
                ...
                if (e.tag.value != "") {
                    new Ajax.Request(e.action.replace(/&xredirect=.+$/, "&ajax=1&tag=") + encodeURIComponent(e.tag.value), {
                        onCreate: function() {
                            e.disable();
